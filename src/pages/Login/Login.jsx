...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    logIn(email, password)
      ...
      .catch((error) => {
        error.code;
        swal("Invaliad!", "User or password!", "error");
      });
  };
  return (
    <div>
                ...
                <div className="flex justify-around gap-5">
                  <Link>
                    <button
                      ...
                      type="submit"
                      className="w-full text-black bg-transparent hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                    >
                      Sign in with Google
                    </button>
                  </Link>
